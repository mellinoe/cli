...
function RunCandle
{
    ...
    .\candle.exe -nologo `
        ...
        -dSharedFramework_Name="$SharedFrameworkNugetName" `
        -dSharedFramework_DisplayVersion="$SharedFrameworkNugetVersion" `
        -dSharedFramework_ComponentVersion="$SharedFrameworkComponentVersion" `
        -dSharedFramework_MSIVersion="1.0.0" `
        -dSharedFramework_UpgradeCode="$SharedFrameworkUpgradeCode" `
        -arch $Architecture `
