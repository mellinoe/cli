    ...
    public class GivenAProjectDependenciesCommandResolver
    {
        ...
        public void It_returns_null_when_CommandName_is_null()
        {
            ...
            var commandResolverArguments = new CommandResolverArguments()
            {
                ...
                Configuration = "Debug",
                Framework = new NuGetFramework(FrameworkConstants.FrameworkIdentifiers.NetCoreApp, new Version(1, 1, 0, 0))
            };
        ...
        public void It_sets_depsfile_in_output_path_in_commandspec()
        {
            ...
            var buildCommand = new BuildCommand(
                ...
                output: outputDir,
                framework: new NuGetFramework(FrameworkConstants.FrameworkIdentifiers.NetCoreApp, new Version(1, 1, 0, 0)).ToString())
                .Execute().Should().Pass();

            var projectContext = ProjectContext.Create(
                s_liveProjectDirectory,
                new NuGetFramework(FrameworkConstants.FrameworkIdentifiers.NetCoreApp, new Version(1, 1, 0, 0)),
