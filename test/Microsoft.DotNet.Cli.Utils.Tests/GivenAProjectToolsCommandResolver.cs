...
namespace Microsoft.DotNet.Cli.Utils.Tests
{
    ...
    {
        private static readonly NuGetFramework s_toolPackageFramework = new NuGetFramework(FrameworkConstants.FrameworkIdentifiers.NetCoreApp, new Version(1, 1, 0, 0));
